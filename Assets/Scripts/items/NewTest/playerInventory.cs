...
public class playerInventory : MonoBehaviour
{
    ...
    [SerializeField] public ParticleSystem itemUpgrade;
    ...
    {
        TestItemOne item = new TestItemOne();
        items.Add(new ItemList(item, item.GiveName()));
    ...
    IEnumerator CallItemUpdate(){
        foreach(ItemList i in items){
            ...
            i.item.Update(GetComponent<PlayerController>(), GetComponent<PlayerHealth>(),GetComponent<PlayerSouls>(),itemUpgrade);
        }
